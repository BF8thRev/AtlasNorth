...
for f in MEMORY.md SOUL.md AGENTS.md IDENTITY.md USER.md HEARTBEAT.md MODEL_ROUTER.json STANDING_INSTRUCTIONS.md PULSE_BRIEF_SPEC.md WEEKEND_BRIEF_SPEC.md BLOCKERS.json COMPLETED_BLOCKERS.json MISSION_CONTROL_ROUTINES.json WORKFLOW_AUTO.md WORKFLOW_PROTOCOL.md AGENT_TOOL_ACCESS.md TOKEN_USAGE.jsonl ATLAS_SOUL.md USER_IDENTITY.md SYSTEM_ARCHITECTURE.md CALIBRATION_NOTES.md DECISION_TREES.md BRYAN_PROFILE.md ATLAS_MEMORY_EXPORT.txt WORKFLOW_STATE.json ENGAGEMENT_RULES.md DIME_MISSION.md DIME_STRATEGY_WIKI.md DIME_STYLE_GUIDE.md DIME_LEARNINGS.md Newton_tasks.md NEWTON_SALES_PLAYBOOK.md NEWTON_SALES_ANALYSIS.md GENERAL_TASKS.md GENERAL_LEARNINGS.md GENERAL_STYLE_GUIDE.md ROSTER.md TOOLS.md token-log.json FILE_AUDIT_LOG.jsonl MODEL_CALL_LOG_SCHEMA.md MODEL_CALL_LOG_GUIDE.md MORNING_BRIEF.md PULSE_DAILY_OUTPUT.md PULSE_WEEKEND_SAT_OUTPUT.md PULSE_WEEKEND_SUN_OUTPUT.md; do
